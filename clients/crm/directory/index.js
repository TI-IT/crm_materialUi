...
const urls2 = {
    urls2: [
        { routes: 'users', name: 'city', method: 'add' },
        { routes: 'clients', name: 'city', method: 'add' },
        { routes: 'tasks', name: 'city', method: 'add' },
        { routes: 'products', name: 'city', method: 'add' },
        { routes: 'directory', name: 'city', method: 'add' },
        { routes: 'applications', name: 'city', method: 'add' }
    ]
};
